...
<%
	...
	session.setAttribute("prodNo",productVO.getProdNo());
	session.setAttribute("RegDate",productVO.getRegDate());
%>  
...
function fncAddProduct(){
	...
	document.detailForm.action='/updateProduct.do?prodNo=vo.getProdNo()';
...
<input type="hidden" name="prodNo" value="10068"/>
	...
	<tr>
		...
		<td class="ct_write01">
			<input	type="file" name="fileName" class="ct_input_g" 
						style="width: 200px; height: 19px" maxLength="13" value="../../images/<%=productVO.getFileName()%>"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
